...
void waveform_fft_differentruns(){
  ...
  TFile *myFile2 = TFile::Open("Run2_EXFLU1_Compensated_W12_pad1.3_2.5E15neq_-25C/stats_Sr_Run2_300V_trig2750V.root");
  ...
  // SIGNAL WAVEFORMS (events 4984 and 4997)



  // SIGNAL WAVEFORM 1 (4984)
  ...
  for(int i = 0; i < n; i++)
  {
    hfftm_rebin5->SetBinContent(i, hfftm5->GetBinContent(i)/sqrt(n));
  }
  ...
  for(int i = 0; i < n; i++)
  {
    hfftm_rebin6->SetBinContent(i, hfftm6->GetBinContent(i)/sqrt(n));
  }
  ...
  for(int i = 0; i < n; i++)
  {
    hfftm_rebin7->SetBinContent(i, hfftm7->GetBinContent(i)/sqrt(n));
  }
  ...
  for(int i = 0; i < n; i++)
  {
    hfftm_rebin8->SetBinContent(i, hfftm8->GetBinContent(i)/sqrt(n));
  }
  ...
  legend1->AddEntry(hwave1,"Run 3 W13: Signal Waveform (event 7111)");
  legend1->AddEntry(hwave2,"Run 3 W13: Signal Waveform (event 7459)");
  legend1->AddEntry(hwave3,"Run 3 W13: Noise Waveform (event 7000)");
  legend1->AddEntry(hwave4,"Run 3 W13: Noise Waveform (event 20000)");
  legend1->AddEntry(hwave5,"Run 2 W12: Signal Waveform (event 4984)");
  legend1->AddEntry(hwave6,"Run 2 W12: Signal Waveform (event 4997)");
  legend1->AddEntry(hwave7,"Run 2 W12: Noise Waveform (event 7000)");
  legend1->AddEntry(hwave8,"Run 2 W12: Noise Waveform (event 20000)");
